...
; The script shows the order of execution of the 'Close' and 'Minimize' menu items
...
MsgBox 'Select the "This & That" menu item or minimize/close the window to demonstrate the effect of using the Callback property.'
